...
def make_pass_decorator(object_type: t.Type, ensure: bool = False) -> "t.Callable[[F], F]":
...
def pass_meta_key(key: str, *, doc_description: t.Optional[str] = None) -> "t.Callable[[F], F]":
